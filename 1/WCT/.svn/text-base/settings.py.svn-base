# Django settings for WCT project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'XQEBHEZAIkueQpsHWaah',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'x!a-)g_2-y2r3#gu*_u7ohsi5945^8=3x6dnv!q@oc#&amp;487q!l'
...
ROOT_URLCONF = 'WCT.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'WCT.wsgi.application'
import os.path
TEMPLATE_DIRS = (
